...
void OnTimer(HWND, UINT, WPARAM, LPARAM);
void OnDestroy();
int LoopMessage();
...
void OnCreate(HWND hWnd, UINT msgID, WPARAM wParam, LPARAM lParam)
{
	SetTimer(hWnd,1,1000,NULL);
	SetTimer(hWnd,2,2000,NULL);
}

void OnTimer(HWND hWnd, UINT msgID, WPARAM wParam, LPARAM lParam)
{
	TCHAR szText[256];
	wsprintf(szText, TEXT("定时器ID=%d\n"),(INT)wParam);  
